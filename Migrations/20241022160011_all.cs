        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: true, computedColumnSql: "[FName] + ' ' + [LName]"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 10, 22, 19, 0, 8, 76, DateTimeKind.Local).AddTicks(5193), 0, "Designed for comfort and style, the Mailo Pants offer a relaxed fit with soft, breathable fabric—your go-to for any occasion.", 0m, "~/assets/blackpants1.jpeg", "Mailo basha pants", 750m, 3, null });
